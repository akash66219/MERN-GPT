...
exports.deleteChat = exports.generateChatCompletion = void 0;
var user_js_1 = require("../models/user.js");
var openai_config_js_1 = require("../utils/openai-config.js");
var g4f_1 = require("g4f");
var generateChatCompletion = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var message, g4f, user, chats, chatResponse, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, g4f.chatCompletion(chats, openai_config_js_1.chatOptions)];
            case 3:
            ...
            case 4:
                _a.sent();
                return [2 /*return*/, res.status(200).send({ response: chatResponse })];
            case 5:
                error_1 = _a.sent();
                console.log(error_1);
...
var deleteChat = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                _a.sent();
                return [2 /*return*/, res.status(200).json({ msg: "Chats deleted successfully!" })];
            case 3:
                err_1 = _a.sent();
